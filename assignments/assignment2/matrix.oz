...
class Matrix
   ...
   meth display()
      ...
      %% Output: None (void)
      for I in 1..@size do
         {Show {List.nth @data I}}
      end
   end
end

local Matrix1 N R1 R2 R3 R4 R5 R6 R7 R8 R9 Exc1 Exc2 Exc3 Exc4 Exc5 Exc6 Exc7 Exc8 Exc9 in
   ...
   {Browse R8}
   {Matrix1 productAll(R9)} % R9 = 362880 --> 9!
   {Browse R9}
   ...
   {Matrix1 display()} % Displays the matrix
end